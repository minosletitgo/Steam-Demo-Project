...
public class F_HammermanTotem : IBase_Friend_TotemBuilding
{
    protected override void Awake()
    {
        m_emBuildingType = EM_F_BuildingType.F_HammermanTotem;
        m_emLinkFactoryType = EM_F_BuildingType.F_HammermanFactory;
        m_emLinkCharacterType = EM_F_CharacterType.F_Hammerman;
