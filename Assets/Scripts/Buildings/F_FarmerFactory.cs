...
public class F_FarmerFactory : IBase_Friend_FactoryBuilding
{
    [SerializeField]
    ...
    {
        m_emBuildingType = EM_F_BuildingType.F_FarmerFactory;
        m_emBornCharacterType = EM_F_CharacterType.F_Farmer;
                ...
                case EM_F_CharacterType.F_Villager:
                    {
                        ...
                        if (objOrder != null)
                        {
                            ...
                            if (stOrder.GetOType() == EM_F_AIActionOrderType.ProducingFarmer)
                            {
    ...
    public override void OnMoneyCoinFinished()
    {
        F_AIActionOrderManager.Instance.GetOrderHandler(EM_F_AIActionOrderHandler.Villager).
            CreateOrder(EM_F_AIActionOrderType.ProducingFarmer, this);
    }
}
