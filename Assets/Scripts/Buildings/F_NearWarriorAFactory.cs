...
public class F_NearWarriorAFactory : IBase_Friend_FactoryBuilding
{
    [SerializeField]
    ...
    {
        m_emBuildingType = EM_F_BuildingType.F_NearWarriorAFactory;
        m_emBornCharacterType = EM_F_CharacterType.F_NearWarriorA;
                ...
                case EM_F_CharacterType.F_Villager:
                    {
                        ...
                        if (objOrder != null)
                        {
                            ...
                            if (stOrder.GetOType() == EM_F_AIActionOrderType.ProducingNearWarriorA)
                            {
    ...
    public override void OnMoneyCoinFinished()
    {
        F_AIActionOrderManager.Instance.GetOrderHandler(EM_F_AIActionOrderHandler.Villager).
            CreateOrder(EM_F_AIActionOrderType.ProducingNearWarriorA, this);
    }
}
