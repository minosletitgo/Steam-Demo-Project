...
public class F_KnightTotem : IBase_Friend_TotemBuilding
{
    protected override void Awake()
    {
        m_emBuildingType = EM_F_BuildingType.F_KnightTotem;
        m_emLinkFactoryType = EM_F_BuildingType.F_KnightFactory;
        m_emLinkCharacterType = EM_F_CharacterType.F_Knight;
