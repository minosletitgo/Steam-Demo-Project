...
public class F_BowmanTotem : IBase_Friend_TotemBuilding
{
    protected override void Awake()
    {
        m_emBuildingType = EM_F_BuildingType.F_BowmanTotem;
        m_emLinkFactoryType = EM_F_BuildingType.F_BowmanFactory;
        m_emLinkCharacterType = EM_F_CharacterType.F_Bowman;
