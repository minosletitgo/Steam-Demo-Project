...
public class F_FarmerTotem : IBase_Friend_TotemBuilding
{
    protected override void Awake()
    {
        m_emBuildingType = EM_F_BuildingType.F_FarmerTotem;
        m_emLinkFactoryType = EM_F_BuildingType.F_FarmerFactory;
        m_emLinkCharacterType = EM_F_CharacterType.F_Farmer;
