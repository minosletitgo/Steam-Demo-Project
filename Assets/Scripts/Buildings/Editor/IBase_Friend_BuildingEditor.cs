...
[CustomEditor(typeof(IBase_Friend_Building), true)]
[InitializeOnLoad]
public class IBase_Friend_BuildingEditor : Editor
{
    /// <summary>
    ...
    protected virtual void OnSceneGUI()
    {
        ...
        IBase_Friend_Building stHost = (target as IBase_Friend_Building);
