...
public class F_HammermanFactory : IBase_Friend_FactoryBuilding
{
    [SerializeField]
    ...
    {
        m_emBuildingType = EM_F_BuildingType.F_HammermanFactory;
        m_emBornCharacterType = EM_F_CharacterType.F_Hammerman;
                ...
                case EM_F_CharacterType.F_Villager:
                    {
                        ...
                        if (objOrder != null)
                        {
                            ...
                            if (stOrder.GetOType() == EM_F_AIActionOrderType.ProducingHammerman)
                            {
    ...
    public override void OnMoneyCoinFinished()
    {
        F_AIActionOrderManager.Instance.GetOrderHandler(EM_F_AIActionOrderHandler.Villager).
            CreateOrder(EM_F_AIActionOrderType.ProducingHammerman, this);
    }
}