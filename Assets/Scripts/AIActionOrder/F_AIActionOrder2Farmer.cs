...
public class F_AIActionOrder2Farmer : IBase_Friend_AIActionOrder
{
    public F_AIActionOrder2Farmer(EM_F_AIActionOrderHandler emHandler) : base(emHandler)
    {
    ...
    protected override void TryLinkOrder2TargetAIChar(ST_F_AIActionOrder stOrder, IBase_Friend_Character stIdleChar)
    {
        ...
        {
            Debug.LogWarning("F_AIActionOrder2Farmer.TryLinkOrder2TargetAIChar Failed !");
            return;
        }
        ...
        if (stOrder != null)
        {
            ...
            {
                case EM_F_AIActionOrderType.Farming:
                    {
