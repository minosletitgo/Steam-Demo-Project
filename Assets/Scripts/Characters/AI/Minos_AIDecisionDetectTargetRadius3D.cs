...
namespace MoreMountains.TopDownEngine
{
    ...
    /// </summary>
    public class Minos_AIDecisionDetectTargetRadius3D : AIDecision
    {
        ...
        public bool CareGameDate = true;
        public bool GameDateIsDay = true;
        ...
        protected virtual bool DetectTarget()
        {
            ...
            if (CareGameDate)
            {
                if (Minos_GameDateManager.Instance.IsDayOrNight() != GameDateIsDay)
                {
                    return false;
                }
            }            
            ...
            if (_hit.Length > 0)
            {
                ...
                if (hit.collider == null)
                {
                    _brain.Target = _boxNearest.transform;
                    return true;
                }
                else
                {
