...
public class BD_Parallel_SharedBool : Parallel
{
    public SharedBool targetReturnFailure;
    public SharedBool targetReturnFailureCompareTo;
    ...
    public override TaskStatus OverrideStatus(TaskStatus status)
    {
        ...
        for (int i = 0; i < executionStatus.Length; ++i)
        {
            ...
            //}
            else if (targetReturnFailure.Value.Equals(targetReturnFailureCompareTo.Value))
            {
                return TaskStatus.Failure;
            }
        }
