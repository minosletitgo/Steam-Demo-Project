...
namespace MoreMountains.TopDownEngine
{
	...
	public class Health : MonoBehaviour
	{
		...
		public OnDeathDelegate OnDestroyObject;
		...
		protected virtual void Initialization()
		{
            ...
            //DamageFeedback.Initialization(this.gameObject);
            //DeathFeedback.Initialization(this.gameObject);
		...
		public virtual void GetHealth(int health,GameObject instigator)
		{
            ...
            MMDamageTakenEvent.Trigger(_character, instigator, CurrentHealth, health, previousHealth);
